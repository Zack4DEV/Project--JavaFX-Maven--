...
abstract class Player {
    ...
    public void play() throws MediaException {
        ...
        medradioPlayer.play(hlmedradio);
        }
        ...
        atlanticPlayer.play(hlatlantic);
        }
        ...
        hitradioPlayer.play(hlhitradio);
        }
        ...
        hitmarocPlayer.play(hlhitmaroc);
        }
        ...
        moroccoenglishPlayer.play(hlmoroccoenglish);
        }
        ...
        tamazghaPlayer.play(hltamazgha);
        }
        ...
        montecarloPlayer.play(hlmontecarlo);
        }
        ...
        aljazeeraPlayer.play(hlaljazeera);
        }
        ...
        skybewsarabiaPlayer.play(hlskybewsarabia);
        }
        ...
        bbcarabicPlayer.play(hlbbcarabic);
        }
